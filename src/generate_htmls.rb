      ...
      <header>
        <nav class="navbar fixed-top navbar-expand-lg navbar-light bg-light">
          <div class="container-fluid">
            ...
            <button type="button" class="navbar-toggler mb-1" data-bs-toggle="collapse" data-bs-target="#navbarNavAltMarkup" aria-controls="navbarNavAltMarkup" aria-expanded="false" aria-label="ナビゲーションの切替">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
              <ul class="navbar-nav ms-auto align-items-end">
                ...
                <li class="nav-item mx-1 my-1">
                  <a class="btn btn-outline-dark" href="../index.html">トップ</a>
                </li>
              </ul>
            </div>
          </div>
